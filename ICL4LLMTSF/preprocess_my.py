...
from models.Preprocess_Llama import Model_my
import numpy as np
...
if __name__ == "__main__":
    # main(root_path="/media/zhangjianqi/D/python_code/AutoTimes-v2/dataset/ETTh1/",
    #      dataset="ETTh1")
    # main(root_path="/media/zhangjianqi/D/python_code/AutoTimes-v2/dataset/weather/",
    #      dataset="weather")
    # main(root_path="/media/zhangjianqi/D/python_code/AutoTimes-v2/dataset/electricity/",
    #      dataset="electricity")
    main(root_path="/media/zhangjianqi/D/python_code/AutoTimes-v2/dataset/ETTh2/",
         dataset="ETTh2")
